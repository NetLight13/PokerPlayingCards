...
bool Card::isValid() const {
	return (m_value >= ACE) && (m_value <= KING);
}
...
bool Card::sameSuit(const Card & c)
{
	return c.m_suit == m_suit;
}
...
bool Card::hasSuit(Suit getSuit)
{
	return m_suit == getSuit;
}

bool Card::hasValue(int getValue)
{
